...
if __name__ == "__main__":
    ...
    if option==4:    
        ...
        print("R11: Memory used in BFS is more than in IDS")
        ...
        print(f"R12: Average path cost for BFS is {cost1/iterations}, and for IDS is {cost2/iterations}")
